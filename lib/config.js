...
{ app:
  ...
  , namespace: process.env.APP_NS || (cfg.app || {}).namespace || '/'
...
, oauth:
  { google:
    { clientId: process.env.GOOGLE_CLIENT_ID || ((cfg.oauth || {}).google ||{}).clientId || ''
    , clientSecret: process.env.GOOGLE_SECRET || ((cfg.oauth || {}).google || {}).clientSecret || ''
    }
  , facebook:
    { clientId: process.env.FACEBOOK_CLIENT_ID || ((cfg.oauth || {}).facebook ||{}).clientId || ''
    , clientSecret: process.env.FACEBOOK_SECRET || ((cfg.oauth || {}).facebook || {}).clientSecret || ''
    }
  , github:
    { clientId: process.env.GITHUB_CLIENT_ID || ((cfg.oauth || {}).github || {}).clientId || ''
    , clientSecret: process.env.GITHUB_CLIENT_SECRET || ((cfg.oauth || {}).github || {}).clientSecret || ''
    }
  }
}
